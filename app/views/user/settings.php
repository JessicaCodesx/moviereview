    ...
    <div class="settings-section">
        ...
        <form id="updateProfileForm">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($data['user']['username']); ?>" required class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="bio" name="bio" class="form-control" rows="3"><?php echo htmlspecialchars($data['user']['bio']); ?></textarea>
            </div>
            ...
            <div id="profileMessage" class="auth-message">
            </div>
        </form>
    </div>
        ...
        <form id="updatePreferencesForm">
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" id="email_notifications" name="email_notifications" class="form-check-input" <?php echo $data['preferences']['email_notifications'] ? 'checked' : ''; ?>>
            ...
            <div id="preferencesMessage" class="auth-message">
            </div>
        </form>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deactivateAccountForm">
                    ...
                    <div id="deactivateMessage" class="auth-message">
                    </div>
                </form>
            </div>
        </div>
